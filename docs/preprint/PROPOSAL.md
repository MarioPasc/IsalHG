...
**Companion documents.**
- `docs/preprint/DATA.md` — authoritative cohort spec (10 downloadable real-data
  ...
  expanded there.
- `docs/engineering/CODE_DESIGN.md` — where each kind of code goes.
- `docs/engineering/DEVELOPMENT.md` — living phase-by-phase status.
...
**Headline.** Three-way (LLM verdict, nauty ground truth, IsalHG verdict) on the only published hypergraph iso-recognition benchmark in the field. Full per-dataset narrative in `docs/preprint/DATA.md` §2.6.
