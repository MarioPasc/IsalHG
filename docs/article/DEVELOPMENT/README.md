...
| [`T-M7`](T-M7/) | Pre-writing revision, code: strict corpora + sweep/stats harness + baselines + G3 + real anchor | 1 (+1 blocked) | 11 |
| [`T-M8`](T-M8/) | Pre-writing revision, docs: label-family Remark, capability matrix, motivation, repro artifact | 1 | 4 |
